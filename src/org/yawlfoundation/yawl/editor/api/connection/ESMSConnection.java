 ...
 * @date 8/09/11
 */
public class ESMSConnection extends YConnection {
    ...
    public ESMSConnection(String urlStr) { super(urlStr); }

    public ESMSConnection(URL url) { super(url); }
